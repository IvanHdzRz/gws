...
namespace BasePickingExample
{
    ...
    /// </summary>
    public class BasePickingExampleRESTServicePropChangeManager : IBasePickingExampleRESTServicePropChangeManager
    {
        // Dependencies
        readonly IBasePickingExampleConfigRepository _ConfigRepository;
        ...
        public BasePickingExampleRESTServicePropChangeManager(IBasePickingExampleConfigRepository configRepository,
                                                     IRESTDataPath dataPath)
        {
            _ConfigRepository = configRepository;
            QueuePath = Path.Combine(dataPath.Path, "BasePickingExamplemodule_http_queue.bin");
        ...
        public string BaseUrl
        {
            get
            {
                ...
                return $"{protocol}://{host}:{port}/BasePickingExampleServer/services/dummyService";
            }
        }
