...
namespace GWS.NetCore
{
    ...
    /// access to the resources from DevKitNetCoreResources.resx.  Since we aren't
    /// actually referencing any of the symbols generated by the designer, save
    /// some code and reduce the size of the app.
    /// </summary>
    public static class DevKitNetCoreResources
    {
        ...
        public static ResourceManager ResourceManager
        {
            get
            {
                ...
                {
                    _ResourceManager = EmbeddedResourceUtil.GetResourceByType(typeof(DevKitNetCoreResources));
                }
