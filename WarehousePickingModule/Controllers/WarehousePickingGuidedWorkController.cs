...
namespace WarehousePicking
{
    ...
    /// </summary>
    public class WarehousePickingGuidedWorkController : GuidedWorkWorkflowController
    {
        public WarehousePickingGuidedWorkController(WorkflowViewControllerDependencies dependencies,
            IGuidedWorkRunner guidedWorkRunner, IWarehousePickingMobileDataExchange mobileDataExchange, IDialogueRunner dialogueRunner, IModal modal, IGuidedWorkStore guidedWorkStore)
