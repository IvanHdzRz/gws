...
namespace VoiceLink.Artisan 
{
    ...
    class NetCoreApplication : BaseNetCoreApplication
    {
        ...
        protected override void RegisterApplication(TinyIoCContainer container)
        {
            ...
            Dependencies.RegisterAppModule<VoiceLinkModule, IGenericMobilDataExchange<IVoiceLinkModel>, IVoiceLinkModel, IVoiceLinkConfigRepository>(container);
        }
    }
