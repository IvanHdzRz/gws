...
namespace OrderPicking
{
    ...
    public partial class OrderPickingConfirmationView : CoreView
    {
        public OrderPickingConfirmationView(OrderPickingConfirmOverflowViewModel viewModel, ILog logger) : base(viewModel, logger)
        {
            InitializeComponent();
            BindingContext = viewModel;

            AddButton(0, "NegativeButtonText", "SecondaryButtonStyle", "NegativeCommand", "OrderPickingConfirmationViewNegativeButton");
            AddButton(1, "AffirmativeButtonText", "PrimaryButtonStyle", "AffirmativeCommand", "OrderPickingConfirmationViewAffirmativeButton");
        }
