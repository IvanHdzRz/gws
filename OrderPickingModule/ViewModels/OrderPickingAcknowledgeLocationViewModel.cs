...
namespace OrderPicking
{
    ...
    /// <summary>
    /// Order picking acknowledge location view model.
    /// </summary>
    public class OrderPickingAcknowledgeLocationViewModel : SingleResponseViewModel, IOrderPickingViewModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderPickingAcknowledgeLocationViewModel"/> class.
        /// </summary>
        /// <param name="dependencies">The dependencies.</param>
        public OrderPickingAcknowledgeLocationViewModel(WorkflowViewModelDependencies dependencies)
            : base(dependencies)
        {
        }
