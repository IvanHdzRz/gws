...
namespace BasePicking
{
    ...
    public class BasePickingServerSettingsViewModel : NavigatingMenuViewModel
    {
        public BasePickingServerSettingsViewModel(WorkflowViewModelDependencies dependencies,
       ...
       /// <summary>
        ...
        private bool _ShowConfigurationSettings;
        public bool ShowConfigurationSettings
        {
            get
            {
                return _ShowConfigurationSettings;
            }
            set
            {
                _ShowConfigurationSettings = value;
                NotifyPropertyChanged();
            }
        }
    }
