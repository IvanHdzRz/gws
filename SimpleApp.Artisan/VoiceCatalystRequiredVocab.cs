...
namespace SimpleApp.Artisan
{
    ...
    ///         
    /// In the SimpleApp sample module, the Yes and no are mapped to custom keys,
    ...
    ///       in the SimpleAppModuleVocab class, and still use the custom keys SimpleApp_ButtonText_Yes
    ///       and SimpleApp_ButtonText_No respectively, but in here we provide additional/different spoken
    ///       and display keys
    ///       
    ...
    public class VoiceCatalystRequiredVocab : DefaultVoiceCatalystRequiredVocab
    {
        ...
        /// </summary>
        public override NoVoiceCatalystVocabMapping NoVocabMapping => new NoVoiceCatalystVocabMapping(new VocabWordInfo("SimpleApp_ButtonText_No", "VocabWord_No", "VocabWord_No"));

        /// <summary>
        /// The mapping between the Voice Catalyst "yes" vocabulary word and
        /// the Guided Work <see cref="T:Honeywell.Firebird.CoreLibrary.VocabWordInfo"/>.
        /// </summary>
        public override YesVoiceCatalystVocabMapping YesVocabMapping => new YesVoiceCatalystVocabMapping(new VocabWordInfo("SimpleApp_ButtonText_Yes", "VocabWord_Yes", "VocabWord_Yes"));
    }
}