...
namespace Receiving
{
    ...
    public partial class ReceivingEnterTiQuantityView : ReceivingView
    {
        public ReceivingEnterTiQuantityView(ReceivingEnterDigitsViewModel viewModel, ILog logger) : base(viewModel, logger)
        {
            InitializeComponent();
            BindingContext = viewModel;
            EnableTiQuantityEntry();
        }
